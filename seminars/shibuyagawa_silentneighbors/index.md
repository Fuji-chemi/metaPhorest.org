...
### ②Interactive Float 
Based on the Shibuya River's flow velocity data for that day, a visual representation of the water current appears on the river's surface. In this way, the river's movement and speed—difficult to perceive in the nighttime urban space—are visualized as a digital flow of light, emerging as a perceptible presence within the city. The projected water current synchronizes with the actual river's inherent rhythm and direction, also serving as an indicator for reading the flow.
